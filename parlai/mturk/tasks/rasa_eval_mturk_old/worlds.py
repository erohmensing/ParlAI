...
class RasaEvaluatorWorld(MTurkTaskWorld):
    ...
    def __init__(self, opt, model_agent, task_opt, mturk_agent):
        self.task_world = create_task(task_opt, model_agent)  # parlai/core/worlds
