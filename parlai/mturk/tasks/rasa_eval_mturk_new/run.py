...
from parlai.mturk.tasks.rasa_eval_mturk_new.worlds import \
    QADataCollectionOnboardWorld, QADataCollectionWorld
from parlai.mturk.core.mturk_manager import MTurkManager
from parlai.mturk.tasks.rasa_eval_mturk_new.task_config import task_config
import os
import importlib
...
def main():
    ...
    module_name = 'parlai.tasks.rasa_eval_new.agents'
